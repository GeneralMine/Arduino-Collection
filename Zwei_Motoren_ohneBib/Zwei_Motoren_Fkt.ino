...
void MotorenMove(int mV, int pwm)  // Funktion zum Ansteuern der Motoren
{  
  ...
  analogWrite(enableM1Pin, pwm);    // Ansteuern PWM Motor 1
  analogWrite(enableM2Pin, pwm);    // Ansteuern PWM Motor 2
}    // fkt
