...
alles auf LCD und Monitor, speichert Zeit und LM35 Sensor, BD löscht und BR liest File   */
...
unsigned long interval = 5000;       // Intervallzeit (1 Sek aus, 1 Sek an == 2 Sekunden)
int lcdAnzMode = 0;
...
void loop()
{
  ...
  if (writeSD_LM35Temp(resultTemp))
  {
