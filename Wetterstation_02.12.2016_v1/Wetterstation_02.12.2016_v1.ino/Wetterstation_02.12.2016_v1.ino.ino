...
#define DHTPIN 6                        //Der Daten Pin des DHTs wird auf 1 festgelegt
...
LiquidCrystal lcd(9,8,5,4,3,2);         //initialisierung der Bibliothek mit den Nummern der Pins des Displays
